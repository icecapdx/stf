...
class SonicthefightersApp : public rex::ui::WindowedApp, public rex::ui::WindowListener {
public:
    static std::unique_ptr<rex::ui::WindowedApp> Create(rex::ui::WindowedAppContext& ctx) {
        return std::make_unique<SonicthefightersApp>(ctx);
    }

    SonicthefightersApp(rex::ui::WindowedAppContext& ctx)
        : WindowedApp(ctx, "sonicthefighters", "[game_directory]") {
    ...
    bool OnInitialize() override {
        ...
        REXLOG_INFO("sonicthefighters starting");
        ...
        // Create window
        window_ = rex::ui::Window::Create(app_context(), "sonicthefighters", 1280, 720);
        if (!window_) {
...
XE_DEFINE_WINDOWED_APP(sonicthefighters, SonicthefightersApp::Create)
...
GUEST_FUNCTION_STUB(__imp__MmLockAndMapSegmentArray);
GUEST_FUNCTION_STUB(__imp__MmUnlockAndUnmapSegmentArray);
...
GUEST_FUNCTION_STUB(__imp__XAudioGetDuckerLevel);
GUEST_FUNCTION_STUB(__imp__XAudioGetDuckerReleaseTime);
GUEST_FUNCTION_STUB(__imp__XAudioGetDuckerAttackTime);
GUEST_FUNCTION_STUB(__imp__XAudioGetDuckerHoldTime);
GUEST_FUNCTION_STUB(__imp__XAudioGetDuckerThreshold);
...
GUEST_FUNCTION_STUB(__imp__NtWriteFileGather);
